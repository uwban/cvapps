...
DB_User=""
DB_Pswd=""
SQL_Remote="./remote_date.sql"
SQL_Current="./current_date.sql"
SQL_Refresh="./refresh.sql"
SQL_Refresh_temp="./refresh_temp.sql"
SQL_Current_Meddra="./current_meddra.sql"
SQL_Remote_Meddra="./remote_meddra.sql"
